...
def main():
    ...
    parser.add_argument("--long_format_expression_matrix", required=True, help="Path to long format expression matrix.")
    ...
    long_format_expression_matrix_path_input = args.long_format_expression_matrix
    ...
    long_format_annotated = pd.read_csv(long_format_expression_matrix_path_input, compression = "gzip", sep="\t")
