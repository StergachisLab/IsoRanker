...
from IsoRanker import (
    ...
    calculate_z_score,
    NMD_test_statistic,
    NMD_hap1_test_statistic,  # ADDED
    NMD_hap2_test_statistic,  # ADDED
...
def main():
    ...
    test_stat_funcs = [
        ...
        ("NMD_hap1", NMD_hap1_test_statistic),  # ADDED
        ("NMD_hap2", NMD_hap2_test_statistic),  # ADDED
    ...
    separated_results_files = {
        ...
        "NMD_hap1_gene_top_ranked_data.tsv.gz",   # ADDED
        "NMD_hap1_isoform_top_ranked_data.tsv.gz", # ADDED
