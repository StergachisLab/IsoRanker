...
def main():
    ...
    ################################################
    # Update classification file from isoquant to match isoseq classification file format
    ################################################
    ...
    classification_data = extract_isoform_gene_mapping(classification_path)
